...
def test_scheduler_fsx_windows_file_system_start(lambda_context, fsx_windows_file_system_start):
...
def test_scheduler_fsx_windows_file_system_stop(lambda_context, fsx_windows_file_system_stop):
    with fsx_stubber as stubbed:
        stubbed.add_response(
            'update_file_system',
            {},
